...
The goal of this project is to predict the price of a house in Ames Iowa, US using certain selected features provided by the dataset.
...
```
On terminal run the following command to start the app on port 8082
flask run --host '127.0.0.1' --port 8082

i.e http://127.0.0.1:8082
```
